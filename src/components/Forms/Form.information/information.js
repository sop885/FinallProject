...
const InformationForm = (props) => {
    ...
    return (
        <div style={{ marginRight: "20%" }} className="myformc">
            <Form>
            <br /> <h2 style={{ textAlign: "center", fontSize: "20px", textShadow: "gray 0 1px 2px",marginBottom:"5%" }}> אופן השימוש באתר</h2>              
                <h2><b>איזור אישי</b></h2>
                <h3 className="h3">.ניתן לשנות את פרטייך בכל עת ע"י לחיצה על "שמור" לאחר ביצוע השינויים<br />
                ...
                <h2><b>הודעות</b></h2>
                <h3 className="h3"> במידה והינך ממלא/ת מקום- כאן יופיעו בקשות למילוי מקום שנשלחו אלייך,
                ...
                <h3 className="h3">כאן תוכל/י לפתוח בקשה למילוי מקום, לאחר הכנסת כל הפרטים הנדרשים לחץ על "המשך", אז יופיעו לך כל המחליפים הזמינים לבקשתך לאחר סינון הנתונים,
                    לאחר מכן עלייך לבחור את מחליפים שלהם הינך מעוניין לשלוח את הבקשה וללחוץ על "שלח בקשה".
                    <br /> פרטי הבקשה יופיעו לך בדף ה"הסטוריה"
                    באפשרותך להתעדכן בסטטוס הבקשה האם אושרה או שעדיין ממתינה לאישור, בקשה שאושרה בצבע ירוק ובקשה שממתינה לאישור בצבע אדום.
                </h3>
                <h2><b>לוח השנה שלי</b></h2>
                <h3 className="h3"> .כאן תוכל/י לראות את הימים שבהם את/ה ממלא/ת מקום או שבהם מחליפים אותך, ימים אלו יסומנו באפור
                </h3>
